    ...
    <main className="relative h-page w-full">
      ...
      >
        <Image
          ...
          fill={true}
          placeholder="blur"
          blurDataURL="data:image/jpeg;base64,"
        />
        {files.map((file) => (
          <div
            key={file.id}
